  ...
  <div class="pointMall-container">
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="nextadd()">新建下一个商品</el-button>
...
<script>
  ...
  import { uploadByImg, addInfo } from "@/api/goods";
    ...
    data() {
      return {
        ...
        rules: {
          ...
          product_img: [
            { required: true, message: "请填写商品图片", trigger: "change" },
          ],
          receive: [
