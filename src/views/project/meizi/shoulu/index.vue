  ...
  <div class="table-container">
    ...
    >
      ...
      <el-table-column
        ...
        width="95"
      ></el-table-column>
       <el-table-column show-overflow-tooltip label="节目名称">
        <template #default="scope">
      ...
      <el-table-column
        ...
        prop="date"
      ></el-table-column>
      <el-table-column show-overflow-tooltip label="添加人/时间" >
        <template #default="scope">
       ...
       <el-table-column show-overflow-tooltip label="操作" >
        <template #default="{ row }">
          ...
          <el-button type="text" @click="handleEdit(row)">日志</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
