<template>
  ...
  >
    <el-row :gutter="20">
      ...
      <el-col :span="14">
        <el-form  ref="form" :model="form" label-width="80px" class="mt30">
          ...
          <p style="margin: 30px 10px 20px 10px;">最长60秒，建议15秒</p>
          <el-button style="width: 100%;margin: 0 10px;" type="primary">确定</el-button>
        </el-form>
      </el-col>
    </el-row>
    <el-table
    ...
    >
      <el-table-column show-overflow-tooltip align="center" label="标题" width="240">
